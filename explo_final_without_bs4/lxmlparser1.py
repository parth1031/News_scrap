...
class HTMLParser:
    ...
    def remove_scripts(self,element):
        # Iterate through all descendants of the element
        for descendant in element.iterdescendants():
            # Check if the descendant is a script element
            if descendant.tag == 'script' or descendant.tag == 'style':
                # Remove the script element and its content
                descendant.getparent().remove(descendant)

        # Get the text content from the lxml element after removing scripts
